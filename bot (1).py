...
BOT_TOKEN = "8896432342:AAG7t1yrppdFhxPa8aEhKP6PA7iW_wdt2kE  "
API_KEY = "MURAD_D661DB2358E3C3E959576AF0"
...
OTP_GROUP_ID = https://t.me/theuniquesms

# ==================== WELCOME MESSAGE CONFIGURATION ====================
WELCOME_MESSAGE = """⚡The_unique⚡ 
...
SUPPORT_LINK = "https://t.me/TheUniqueSupport"      # সাপোর্ট লিংক পরিবর্তনযোগ্য
...
def withdraw_method_keyboard():
    keyboard = ReplyKeyboardMarkup([
        ...
        [KeyboardButton(f"🚀 {make_bold_unicode('NAGAD')}", style="primary"), KeyboardButton(f"🏦 {make_bold_unicode('BINANCE')}", style="primary")],
                ...
                for otp in otps:
                    ...
                    if (matched_key is not None and
                        ...
                        user_msg = (
                            ...
                            f"<b>💵 ADD BALANCE FOR {OTP_RATE:.0.08f} USD</b>"
                        )
                        ...
                        group_buttons = InlineKeyboardMarkup([
                            [
                                ...
                                InlineKeyboardButton("📢 CHANNEL", url="https://t.me/Uniquesytem", style="primary")
                            ]
                        ])
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "SUPPORT" in text:
        ...
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton("👨‍💻 DEVELOPER", url="https://t.me/TheUniqueSupport", style="danger")]
        ])
